...
# API Endpoints for Pontem Network on Aptos
swap_url = 'https://aptos-network.pro/api/pontemnetwork/swap'
add_liquidity_url = 'https://aptos-network.pro/api/pontemnetwork/addLiquidity'
check_liquidity_url = 'https://aptos-network.pro/api/pontemnetwork/liquidity'
